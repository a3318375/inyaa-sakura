<template>
  <div id="app">
    <a @click="scrollClick"><img class="scroll" src="image/scroll.png"></a>
    <headbar ref="headbar" @showSakura="showSakura"></headbar>
    <router-view class="routerbar" @changeHeadCss="changeHeadCss" @showSakura="showSakura" v-slot="{ Component }">
...
<script>
import Headbar from './page/Headbar.vue'
...
export default {
  ...
  methods: {
    ...
    handleScroll() {
      this.routerLink = this.currentRoute.fullPath;
      if (this.routerLink === '/') {
